...
# @ Create Time: 2021-01-21 19:03:06
# @ Modified time: 2021-01-21 21:22:44
# @ Description:
#
#     Desciption of the pipeline's graph in the PlotNeuralNet framework's language
#
# @ Note: For author's needings the source code of the PlotNeuralNet was adjusted. The to_cor() function
#     was modified to allow define additional colours and to_Conv() was modified to allow non-default
#     colour for the convolutional layer. Modified version of the 'tikzeng.py' file is stored in the
#     'mods/tikzeng.py'. 
#
# ================================================================================================================

# The '../' must be always appended to the PATH
import sys
sys.path.append('../')
