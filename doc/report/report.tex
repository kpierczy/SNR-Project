\documentclass[a4paper,titlepage,12pt,twosides,floatssmall]{mwart}
...
\input{tex/exercise_analysis.tex}
\input{tex/vgg_analysis.tex}
\input{tex/dataset.tex}
\input{tex/classifiers.tex}
\input{tex/deep_nets.tex}
\input{tex/visualisation.tex}
